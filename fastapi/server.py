...
# Using direct req to huggingface Since render Allows only 512mb ram for free tier which 
# is not suffienct to run this models.
...
async def embed_image(file: UploadFile = File(...)):
    try:
        ...
        response = requests.post(IMAGE_MODEL_URL, headers=HEADERS, files=files)
